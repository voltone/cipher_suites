defmodule CipherSuitesTest do
  ...
  test "init_phoenix_endpoint" do
    assert [
           ...
           ] == CipherSuites.init_phoenix_endpoint(https: [ciphers: "aRSA+kEDH+AES256"])
    ...
    assert [http: [port: 80]] == CipherSuites.init_phoenix_endpoint(http: [port: 80])
  end
end
